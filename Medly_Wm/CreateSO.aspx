                            ...
                            <ContentTemplate>
                                ...
                                <div class="col-lg-12">
                                    <div class="col-lg-12" id="Div1" runat="server" style="overflow: auto;">
                                        <asp:GridView ID="grvCreateSo" runat="server" CssClass="table table-striped  flip-content" OnRowCommand="grvCreateSo_RowCommand" AutoGenerateColumns="False" ForeColor="#333333" HorizontalAlign="Center" ShowHeaderWhenEmpty="True" CellPadding="4" GridLines="None" OnRowDataBound="grvCreateSo_RowDataBound">
